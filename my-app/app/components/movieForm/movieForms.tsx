        ...
        <div className="form-group row p-2">
          ...
          <div className="col-sm-5">
            <div className="star-rating">
              <input type="radio" id="10-stars" name="rating" value="10" onClick={(e) => setRating("10")} />
              <label htmlFor="10-stars">&#9733;</label>
              <input type="radio" id="9-stars" name="rating" value="9" onClick={(e) => setRating("9")} />
              <label htmlFor="9-stars">&#9733;</label>
              <input type="radio" id="8-stars" name="rating" value="8" onClick={(e) => setRating("8")} />
              <label htmlFor="8-stars">&#9733;</label>
              <input type="radio" id="7-stars" name="rating" value="7" onClick={(e) => setRating("7")} />
              <label htmlFor="7-stars">&#9733;</label>
              <input type="radio" id="6-stars" name="rating" value="6" onClick={(e) => setRating("6")} />
              <label htmlFor="6-stars">&#9733;</label>
